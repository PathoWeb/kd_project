...
export default function Register () {
  return (
    <>
      <div className='login font-[switch-font] w-full h-screen pt-28 bg-cover bg-center bg-[url(/src/assets/images/Register-bg.jpg)]'>
        <div className='login-box py-10 max-[450px]:w-[95%] w-[400px] md:w-[350px] xl:w-1/4 h-fit bg-[#ffffff56] mx-auto rounded-3xl shadow-xl backdrop-blur-md relative'>
          <div className='login-switch overflow-hidden w-48 h-14 bg-white mx-auto rounded-[30px] absolute top-[-30px] right-0 left-0 flex text-center items-center'>
            <NavLink
              to='/login'
              className={`w-1/2 h-full text-white text-xl bg-[#000211] pt-3`}
            >
              ورود
            </NavLink>
